...
ALTER TABLE [AppBooks] ADD [BookPhotoId] uniqueidentifier NULL;
...
CREATE TABLE [AppBinaryObjects] (
    ...
    [TenantId] int NULL,
    CONSTRAINT [PK_AppBinaryObjects] PRIMARY KEY ([Id])
);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20171019124109_add_file_and_book_support', N'2.0.0-rtm-26452');
...
CREATE TABLE [UserPhotos] (
    ...
    CONSTRAINT [FK_UserPhotos_AppBinaryObjects_PhotoId] FOREIGN KEY ([PhotoId]) REFERENCES [AppBinaryObjects] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_UserPhotos_AbpUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AbpUsers] ([Id]) ON DELETE CASCADE
);

GO

CREATE INDEX [IX_UserPhotos_PhotoId] ON [UserPhotos] ([PhotoId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20171020092250_add_user_photo', N'2.0.0-rtm-26452');
